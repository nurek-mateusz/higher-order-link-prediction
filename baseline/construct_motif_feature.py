...
def construct_x(x_trg, G, train_closed, save_dir, filename):
...
if __name__ == "__main__":
    ...
    with open(save_dir + '/trg_open_val.pickle', 'rb') as f:
        x_val_trg = pickle.load(f)
    with open(save_dir + '/trg_closed_val.pickle', 'rb') as f:
        val_closed = pickle.load(f)
    with open(save_dir + '/y_val.pickle', 'rb') as f:
        y_val = pickle.load(f)
    with open(save_dir + '/G_val.pickle', 'rb') as f:
        G_val = pickle.load(f)
    ...
    x_train = construct_x(x_train_trg, G_train, train_closed, save_dir, filename='train')
    x_val = construct_x(x_val_trg, G_val, val_closed, save_dir, filename='val')
    x_test = construct_x(x_test_trg, G_test, test_closed, save_dir, filename='test')