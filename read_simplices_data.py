...
def split_train_probe(nv_lis, sp_lis, tm_lis, start_ratio, end_ratio, test_ratio, k, dataset, split_type):
    ...
    if split_type == 'events':
        simplices_0_60, simplices_60_80, train_zip = split_data(nv_lis, sp_lis, tm_lis, start_ratio, end_ratio, test_ratio)
    else:
...
def split_data_time(nv_lis, sp_lis, tm_lis, start_ratio, end_ratio, test_ratio):
    ...
    # print(f'min_time: {min_time}, max_time: {max_time}, time_range: {max_time - min_time}, end_ratio: {end_ratio}, start_time: {start_time}, end_time: {end_time}')
    ...
    # print(f'min_time: {min_time}, max_time: {max_time}, end_ratio: {end_ratio}, test_ratio: {test_ratio}, start_time: {start_time}, test_time: {test_time}')
...
if __name__ == "__main__":
    ...
    for dataset in dataset_list:
        ...
        save_dir = './processing_dataset/' + split_type + '/' + dataset
